module ncdump
 ...
 subroutine ncsavebike(x,y,thck,topg,beta, uvel, vvel, velc, &
      divuh, divuhc, temp,n,m,upn,file)
...
program t
  ...
  real (kind = 8), dimension(1:ewn,1:nsn) :: topg, lsrf, usrf, thck, uvel, vvel, velc,divuh, &
       divuhc, beta, betar, dsx, dsy, umod, umodsia
...
!!$
  ...
  call ncsavebike(x,y,thck,topg,beta,uvel,vvel,velc,divuh,divuhc,temp,ewn,nsn,upn,filename)

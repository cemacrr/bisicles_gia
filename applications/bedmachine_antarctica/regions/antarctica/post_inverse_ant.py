...
dx='1km'
out_base = 'bedmachine_antarctica_post_inverse'
...
ctrl =  BisiclesData('inverse/ctrl.ant_bmach.03lev.000024000016.2d.hdf5',
                     level=3,origin=(origin(x),origin(y)),
...
write_ais_nc(ncf, ctrl.x,ctrl.y, {'c_one':c_one, 'c_third':c_third, 'mucoef':mucoef})
nctoamr(ncf,hdf,'c_one c_third mucoef')
